                        ...
                        <nav className="navbar navbar-expand-lg" style={{ 'backgroundColor': '#f5f2f2', 'fontSize': '18px','float': 'right' }}>
                            <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                                <div className="navbar-nav">
                                    ...
                                    <a className="nav-item nav-link" href="#/pendingTickets">Pending<span className="sr-only">(current)</span></a>
                ...
                <table className="table table-hover">
                    <thead style={{ 'backgroundColor': '#f5f2f2' }}>
                        <tr>
                            ...
                            <th width='20%'>Atert Type</th>
                            <th width='20%'>Recieved Time</th>
                            <th width='20%'>Team</th>
